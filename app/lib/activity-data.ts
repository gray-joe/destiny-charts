...
export const activities: MainActivity[] = [
    {
      id: 'raids',
      name: 'Raids',
      description: 'High-level 6-player activities with complex mechanics and powerful rewards.',
    ...
    },
    {
      id: 'dungeon',
      name: 'Dungeons',
      description: '3-player activities featuring challenging encounters and unique mechanics.',
    ...
    },
    {
      id: 'nightfalls',
      name: 'Nightfalls',
      description: 'Challenging versions of strikes with modifiers and high-tier rewards.',
    ...
    },
    {
      id: 'pvp',
      name: 'Crucible',
      description: 'Competitive player-versus-player combat across various game modes.',
    ...
    },
    {
      id: 'gambit',
      name: 'Gambit',
      description: 'Hybrid PvE and PvP activity featuring banking motes and invading.',
