import { fetchAllExoticArmor } from '@/app/lib/data'
...
export default async function EditExoticArmorPage({ params }: Params) {
    const { id } = await params
    const armorList = await fetchAllExoticArmor()
    const armor = armorList.find(a => a.id === id)
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-white mb-2">Edit Exotic Armor</h1>
                <p className="text-gray-400">Update the details for {armor.name}</p>
            </div>

            <form action={`/admin/exotic-armor/${id}/update`} method="POST" className="space-y-8">
                ...
                <div className="bg-primary-dark rounded-lg p-6">
                    ...
                    <div className="mt-6">
                        ...
                        <textarea
                            ...
                            name="description"
                            rows={4}
                            defaultValue={armor.description || ''}
                ...
                <div className="bg-primary-dark rounded-lg p-6">
                    ...
                    <p className="text-gray-400 mb-6">Rate this armor from 1-5 in each category</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                min="1"
                                max="5"
                                defaultValue={armor.survivability || ''}
                                className="w-full px-3 py-2 bg-primary-light text-white rounded-md border border-gray-700 focus:outline-none focus:border-blue-500"
                                placeholder="1-5"
                            />
                        </div>
