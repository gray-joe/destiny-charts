...
import type { MainActivity, SubActivity, EncounterActivity } from '@/app/lib/activity-data';
...
export default function SubSubActivityPage({ 
  ...
  const subActivity = activity?.subActivities?.find(
    sa => sa.id.toLowerCase() === decodeURIComponent(params.subActivity).toLowerCase()
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <Link href={`/build_finder/${activity.id}`} className="text-primary hover:text-primary-dark">
