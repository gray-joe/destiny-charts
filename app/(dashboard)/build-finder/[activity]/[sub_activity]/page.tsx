import { ActivityCard } from '@/app/ui/build-finder/ActivityCard'
import { fetchActivities } from '@/app/lib/data'
import type { MainActivity, SubActivity } from '@/app/lib/definitions'
...
export default async function SubSubActivityPage({
    ...
    const activity = activities.find(
        (activity) => activity.id === resolvedParams.activity
